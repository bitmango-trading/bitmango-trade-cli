...
class SmartStopPhemex(BaseExchange):
    ...
    def calculate_contract_size(self, usd_amount, price):
        # For Phemex USDT linear contracts, the amount parameter in create_order is the quantity of the base asset.
    ...
    def get_contract_size(self, symbol):
        ...
        # For Phemex USDT linear contracts, the 'amount' in orders is the quantity of the base asset.
        # So, the contract size is effectively 1 unit of the base asset.
        # This function might be more relevant for inverse contracts or if Phemex had fixed contract sizes.
