...
def audit_bitfinex():
    print("Auditing Bitfinex CCXT capabilities...")
    ...
    for method in methods_to_check:
        ...
        support_in_has = exchange.has.get(method.replace('fetch', '').replace('create', '').replace('cancel', '').lower(), 'Unknown')
        # Standardize keys for exchange.has
        has_key = method
